...
<PageMeta
  title="Installation"
  description="Step-by-step guide how to install @krowdy-ui/pickers"
/>

## Installation

Available as an [npm package](https://www.npmjs.com/package/@krowdy-ui/pickers)
...
@krowdy-ui/pickers was designed to use the date management library of your choice.
